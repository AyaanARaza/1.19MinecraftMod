...
public class AlchemyTableMenu extends AbstractContainerMenu{
	public final AlchemyTableBlockEntity Block_Entity;
	...
	public AlchemyTableMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
		super(ModMenuTypes.Alchemy_Table_Menu.get(), id);
        checkContainerSize(inv, 3);
        Block_Entity = (AlchemyTableBlockEntity) entity;
	...
	public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, Block_Entity.getBlockPos()),
                player, ExampleMod.alchemy_table.get());
    }
